...
import type PatientVisitMeta from '@/types/PatientVisitMeta'
...
async function getData() {
  try {
    ...
    patientVisits.value = data // Store the fetched data in the patients array
...
function searchPatient() {
  ...
  patientVisits.value = patientVisitsFixed.value.filter((patient) => {
    return (
